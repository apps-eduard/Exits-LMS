...
const MENU_DATA = {
  platform: [
    ...
    // Tenant Management Section (2-4)
    { name: 'Tenants', slug: 'tenants', icon: '🏢', route: '/super-admin/tenants', order: 2, parent: null },
    { name: 'User Tenants', slug: 'user-tenants', icon: '👥', route: '/super-admin/tenants?status=active', order: 3, parent: 'tenants' },
    { name: 'Create Tenant', slug: 'create-tenant', icon: '➕', route: '/super-admin/tenants/create', order: 4, parent: 'tenants' },
    
    // Analytics & Reports Section (5-8)
    { name: 'System Analytics', slug: 'analytics', icon: '📈', route: '/super-admin/analytics', order: 5, parent: null },
    { name: 'Revenue Reports', slug: 'revenue-reports', icon: '💰', route: '/super-admin/reports/revenue', order: 6, parent: 'analytics' },
    { name: 'User Activity Reports', slug: 'user-activity-reports', icon: '👥', route: '/super-admin/reports/user-activity', order: 7, parent: 'analytics' },
    { name: 'Tenant Usage Reports', slug: 'tenant-usage-reports', icon: '🏢', route: '/super-admin/reports/tenant-usage', order: 8, parent: 'analytics' },
    
    // Billing & Subscriptions Section (9-12)
    { name: 'Subscriptions', slug: 'subscriptions', icon: '💳', route: '/super-admin/subscriptions', order: 9, parent: null },
    { name: 'Subscription Plans', slug: 'plans', icon: '📦', route: '/super-admin/plans', order: 10, parent: 'subscriptions' },
    { name: 'Invoices', slug: 'invoices', icon: '🧾', route: '/super-admin/invoices', order: 11, parent: 'subscriptions' },
    { name: 'Payments', slug: 'platform-payments', icon: '💵', route: '/super-admin/payments', order: 12, parent: 'subscriptions' },
    
    // Notifications Section (13-15)
    { name: 'Notifications', slug: 'notifications', icon: '📬', route: '/super-admin/notifications', order: 13, parent: null },
    { name: 'Alerts', slug: 'alerts', icon: '🔔', route: '/super-admin/alerts', order: 14, parent: 'notifications' },
    { name: 'Announcements', slug: 'announcements', icon: '📨', route: '/super-admin/announcements', order: 15, parent: 'notifications' },
    
    // Health and Logs Section (16-21) - Combined Audit Logs and System Logs here
    { name: 'Health and Logs', slug: 'health', icon: '🏥', route: '/super-admin/health', order: 16, parent: null },
    { name: 'Audit Logs', slug: 'audit-logs', icon: '📜', route: '/super-admin/audit-logs', order: 17, parent: 'health' },
    { name: 'System Logs', slug: 'system-logs', icon: '📋', route: '/super-admin/system-logs', order: 18, parent: 'health' },
    ...
    { name: 'Background Jobs', slug: 'jobs', icon: '⚙️', route: '/super-admin/jobs', order: 21, parent: 'health' },
    
    // Settings Section (22-23) - Removed System Roles, Menu Management, Email Templates, Email Configuration, API Management (duplicates)
    { name: 'Settings', slug: 'settings', icon: '⚙️', route: '/super-admin/settings', order: 22, parent: null },
    { name: 'System Settings', slug: 'system-settings', icon: '🔐', route: '/super-admin/settings', order: 23, parent: 'settings' },
    
    // System Users Section (24)
    { name: 'System Users', slug: 'system-users', icon: '👨‍💼', route: '/super-admin/users', order: 24, parent: null }
  ],
...
async function seedMenus() {
  ...
  try {
    ...
    console.log('  • Tenant Management: 3 menus (Tenants, User Tenants, Create)');
    ...
    console.log('  • Settings: 2 menus (removed duplicates, Email Config, API Management)');
