  ...
  template: `
    <div class="p-6">
      <div class="max-w-7xl mx-auto">
        <div class="mb-6">
          <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">💳 Billing History</h1>
          <p class="text-gray-600 dark:text-gray-400">Transaction and payment records</p>
        </div>
        <div class="bg-gradient-to-br from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 rounded-xl p-8 text-center border border-purple-200 dark:border-purple-800">
          ...
          <p class="text-gray-600 dark:text-gray-400 max-w-md mx-auto">
            Billing history and transaction tracking features coming soon.
          </p>
        </div>
      </div>
    </div>
